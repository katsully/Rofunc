...
if __name__ == '__main__':
    ...
    xml_path = os.path.join(rofunc_path, "simulator", "assets", "mjcf", "unitreeG1", "g1_29dof.xml")
    save_path = os.path.join(rofunc_path, "utils", "datalab", "poselib", "data", "target_g1_29dof_tpose.npy")
